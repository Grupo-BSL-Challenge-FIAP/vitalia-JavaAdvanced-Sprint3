...
public class AuthController {
    ...
    @Transactional
    public ResponseEntity<Void> registerTutor(
    ...
    @Transactional
    public ResponseEntity<Void> registerVet(
            @RequestBody @Valid RegisterRequest data
    ) {
    ...
    private ResponseEntity<Void> registerUserWithRole(
            RegisterRequest data,
            String roleName
    ) {
        if (this.appUserRepository
    ...
    public ResponseEntity<Void> register(
            @RequestBody @Valid MobileRegisterRequest data
    ) {
        if (this.appUserRepository
                .findByEmail(data.email())
                .isPresent()) {
